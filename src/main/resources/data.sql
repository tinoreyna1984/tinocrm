...
INSERT INTO facturas (producto_id, cod_factura, forma_pago, fecha_pago) VALUES (2, 'INV0000000001', 'OTRO', curdate());
INSERT INTO facturas (producto_id, cod_factura, forma_pago, fecha_pago) VALUES (3, 'INV0000000002', 'OTRO', curdate());
INSERT INTO facturas (producto_id, cod_factura, forma_pago, fecha_pago) VALUES (4, 'INV0000000003', 'OTRO', curdate());

INSERT INTO ventas (orden_venta, desc_venta, fecha_reserva, estado_venta, factura_id, cliente_id, usuario_id) VALUES ('OV0000000001', 'Venta del Nissan Sentra 2023', curdate(), 'CIERRE_GANADO', 1, 4, 2);
INSERT INTO ventas (orden_venta, desc_venta, fecha_reserva, estado_venta, factura_id, cliente_id, usuario_id) VALUES ('OV0000000002', 'Kawasaki Z1000 2023', curdate(), 'CIERRE_GANADO', 2, 5, 2);
INSERT INTO ventas (orden_venta, desc_venta, fecha_reserva, estado_venta, factura_id, cliente_id, usuario_id) VALUES ('OV0000000003', 'Hyundai Tucson 2024', curdate(), 'CIERRE_GANADO', 3, 6, 3);
